  ...
  return (
      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.highlightWrapper}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View>
              <Text style={styles.highlightText}>Süre</Text>
              <Text style={styles.highlightTextVal}>{listing.duration} Gün</Text>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View>
              <Text style={styles.highlightText}>Kişi</Text>
              <Text style={styles.highlightTextVal}>{listing.duration}</Text>
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View>
              <Text style={styles.highlightText}>Değerlendirme</Text>
    ...
    <Animated.View style={styles.footer} entering={SlideInDown.delay(200)}>
      <TouchableOpacity onPress={() => {}} style={[styles.footerBtn, styles.footerBookBtn]}>
        <Text style={styles.footerBtnText}>Rezervasyon Yap</Text>
      </TouchableOpacity>
